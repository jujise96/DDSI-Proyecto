...
@Table(name = "SOCIO")
@NamedQueries({
    @NamedQuery(name = "Socio.findNombreCategoria", query = "SELECT s.nombre, s.categoria FROM Socio s WHERE s.categoria = :categoria"),
    @NamedQuery(name = "Socio.findNombreTelefono", query = "SELECT s.nombre, s.telefono FROM Socio s"),
